...
---
# Thirdweb AI Agent on Base Mainnet
...
```typescript
// Lightweight tool: $0.01 service fee + gas
// Example: getWalletBalance
// Gas: ~30,000 * 0.2 gwei * $2000 = $0.012
// Total: $0.01 + $0.012 = $0.022 USDC

// Heavyweight tool: $0.10 service fee + gas
// Example: sendTokens
// Gas: ~65,000 * 0.2 gwei * $2000 = $0.026
// Total: $0.10 + $0.026 = $0.126 USDC

// Ultra-Heavy tool: $0.50 service fee + gas
// Example: deployContract
// Gas: ~1,500,000 * 0.2 gwei * $2000 = $0.60
// Total: $0.50 + $0.60 = $1.10 USDC
```
...
✅ **AI Agent on Base Mainnet** - Deployed and ready
